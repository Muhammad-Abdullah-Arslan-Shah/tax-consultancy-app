...
const ContactUs = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-blue-100 via-blue-50 to-blue-100 py-16 overflow-x-hidden" id="contact">
      <div className="container mx-auto px-4 md:px-8">
        <h1 className="text-4xl font-bold text-center text-indigo-500 mb-12 md:text-5xl">
          Get in Touch <span className="text-amber-500">with Us</span>
        </h1>
        <div className="bg-white shadow-lg rounded-lg overflow-hidden grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Contact Information */}
          <div className="bg-gradient-to-br from-indigo-700 to-indigo-700 p-8 text-white flex flex-col">
            <h2 className="text-2xl font-semibold mb-6 md:text-3xl">Contact Information</h2>

            {/* Phone */}
            <div className="mb-6 flex items-start">
              <FaPhoneAlt className="text-amber-500 text-2xl mr-4" />
              <div>
                <h3 className="text-lg font-semibold md:text-xl">Phone Numbers</h3>
            ...
            <div className="mb-6 flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold md:text-xl">Email</h3>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold md:text-xl">Office Address</h3>
                <p className="mt-2">
          ...
          <div className="bg-white p-8 md:p-12">
            <h2 className="text-2xl font-semibold text-indigo-600 mb-6 md:text-3xl">
              Send Us a Message
            </h2>
