        ...
        <div className="w-full lg:w-2/3 flex flex-col justify-between">
          ...
          <div className="flex flex-col justify-center mb-12 lg:mb-0">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 relative">
              Our Mission
              <span className="absolute bottom-[-6px] left-0 w-[150px] h-[5.5px] bg-amber-500"></span>
              <span className="absolute bottom-[-14px] left-0 w-[120px] h-[5px] bg-amber-500"></span>
              <span className="absolute bottom-[-22px] left-0 w-[80px] h-[4px] bg-amber-500"></span>
            </h2>
